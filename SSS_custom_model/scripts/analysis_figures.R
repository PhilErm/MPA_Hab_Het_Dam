...
# # Load in new environment
# simulation.name <- "log_mig_adam_corr+099_fishfav"
# env.path <- paste("../../rds/hpc-work/SSS_custom_model", simulation.name, sep = "/")
...
bio.path <- "../../rds/hpc-work/SSS_custom_model/summaries/summary_files"
...
eff.path <- "../../rds/hpc-work/SSS_custom_model/summaries/effort_files"
...
eff.path <- "../../rds/hpc-work/SSS_custom_model/summaries/habitat_files"
dir.create(eff.path, recursive = TRUE)
RData.path <- paste(eff.path, simulation.name, sep = "/")
