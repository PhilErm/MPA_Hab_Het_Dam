...
source("pars_log_mig_adamtarg_ovr04_fishfav_sens_asparenon.R") # Change this to custom name

# Save parameters used
par.path <- paste("../logs/simulation_parameters", simulation.name, sep = "/")
dir.create(par.path)
file.copy(from = "pars_log_mig_adamtarg_ovr04_fishfav_sens_asparenon.R", 
