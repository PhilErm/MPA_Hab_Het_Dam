...
simulation.name <- "log_mig_adamtarg_ovr08_fishfav_sens_scram"
...
# 6.x = non-targeted species occur in random half of patches
## 6.1 = non-targeted species occur in random half of patches

non.targ.habitat.option <- 6.1
...
# 6.1 = random half of patches are occupied

targ.habitat.option <- 6.1
